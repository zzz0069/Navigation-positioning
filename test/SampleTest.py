...
#            none ... x is pre-validated
    ...
    def test500_010_ShouldCalculateIntegrate(self):
        ...
        def testFunction2(u,n):
            return u ** 6
        mySample = SM.Sample(self.nominalN)
        self.assertAlmostEquals(mySample.integrate(0.0, 1.0, 1, testFunction1), 0.33333, 4)
        self.assertAlmostEquals(mySample.integrate(0.0, 1.0, 1, testFunction2), 0.14285, 4)
